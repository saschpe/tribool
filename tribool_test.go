...
func TestAnd(t *testing.T) {
	...
	if a.And(b) != Indeterminate {
		t.Fail()
	}
	if a.And(c) != False {
		t.Fail()
	}
	if b.And(a) != Indeterminate {
		t.Fail()
	}
	if b.And(b) != Indeterminate {
		t.Fail()
	}
	if b.And(c) != False {
		t.Fail()
...
func TestOr(t *testing.T) {
	...
	if b.Or(b) != Indeterminate {
		t.Fail()
	}
	if b.Or(c) != Indeterminate {
		t.Fail()
	}
	if c.Or(a) != True {
		t.Fail()
	}
	if c.Or(b) != Indeterminate {
		t.Fail()
	}
	if c.Or(c) != False {
		t.Fail()
...
func TestConvertFromString(t *testing.T) {
	if FromString("true") != True {
		t.Fail()
	}
	if FromString("indeterminate") != Indeterminate {
		t.Fail()
	}
	if FromString("false") != False {
		t.Fail()
	}
}
...
func TestConvertToString(t *testing.T) {
	...
	if Indeterminate.String() != "indeterminate" {
		t.Fail()
	}
